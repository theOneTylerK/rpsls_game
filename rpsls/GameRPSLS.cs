    ...
    public class GameRPSLS : Game
    {
        ...
        public override void DisplayRules()
        {
            Console.WriteLine("Welcome to Rock, Paper, Scissors, Lizard, Spock!"
                ...
                + Environment.NewLine +
                "Just like the classic game Rock, Paper, Scissors each player will"
                + Environment.NewLine +
                "decide which gesture they want to play. "
                + Environment.NewLine +
        ...
        public override void CompareGestures(string PlayerOneChoice, string PlayerTwoChoice)
        {
                ...
                (PlayerOneChoice == "lizard" && PlayerTwoChoice == "paper"))
            {
                ...
                (PlayerTwoChoice == "rock" && PlayerOneChoice == "spock"))
            {
                Console.WriteLine(PlayerOneChoice + " beats " + PlayerTwoChoice
                    + " " + PlayerOne.name + " wins the round");
                PlayerOne.WinCounter += 1;
            ...
            switch (SeriesLength)
            {
                ...
                case "best of three":
                    ...
                    while (PlayerOne.WinCounter < 2 && PlayerTwo.WinCounter < 2)
                    {
                        ...
                        {
                            Console.WriteLine("The Final Score is " + PlayerOne.name + ": " + PlayerOne.WinCounter
                                + " " + PlayerTwo.name + ": " + PlayerTwo.WinCounter);
                            Console.WriteLine(PlayerOne.name + " Wins!");
                            break;
                        }
